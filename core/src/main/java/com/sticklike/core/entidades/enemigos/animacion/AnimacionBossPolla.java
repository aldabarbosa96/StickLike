...
public class AnimacionBossPolla {
    ...
    private void reproducirSonido() {
        ...
        switch (sonidoRandom) {
            case 0:
                GestorDeAudio.getInstance().reproducirEfecto("sonidoBossPolla2", 1);
                break;
            case 1:
                GestorDeAudio.getInstance().reproducirEfecto("sonidoBossPolla", 1);
                break;
            case 2:
                GestorDeAudio.getInstance().reproducirEfecto("sonidoBossPolla3", 1);
                break;
            case 3:
                GestorDeAudio.getInstance().reproducirEfecto("sonidoBossPolla4", 1);
                break;
        }
    }
}
